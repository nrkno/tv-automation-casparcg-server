...
void on_abort(int) { CASPAR_THROW_EXCEPTION(invalid_operation() << msg_info("abort called")); }
...
int main(int argc, char** argv)
{
    ...
    try {
		...
		// Log as soon as the logger is ready
		CASPAR_LOG(info) << L"process started";
        ...
        CASPAR_LOG(fatal) << get_message_and_context(e) << " Please check the configuration file ("
